...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                ...
                e.printStackTrace();
                System.out.println("渲染模板失败，表名：" + tableDO.getTableName());
    ...
    public static Configuration getConfig() {
        try {
            return new PropertiesConfiguration("com.lrkj.generator.properties");
...
//		}
        ...
        if (template.contains("list.html.vm")) {
            ...
            //				+ "modules" + File.separator + "com.lrkj.generator" + File.separator + className.toLowerCase() + ".html";
        }
        ...
        if (template.contains("list.js.vm")) {
            ...
            //		+ "modules" + File.separator + "com.lrkj.generator" + File.separator + className.toLowerCase() + ".js";
        }
