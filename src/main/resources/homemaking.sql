...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '服务分类'
  ROW_FORMAT = Dynamic;
...
VALUES (1, '职业保姆', '比较熟悉家庭的生活习惯、卫生标准及饮食口味，对婴幼保育方面也有一定的服务经验，能独立担当日常家庭事物的打理', 1, '2020-05-02 11:43:08',
        '2020-05-02 11:43:08');
INSERT INTO `category`
VALUES (2, '涉外保姆', '具备高端家庭事务的打理和管理，擅长儿童中英文教育和学习辅导', 1, '2020-05-02 11:47:08', '2020-05-02 17:49:18');
INSERT INTO `category`
VALUES (3, '高级管家', '既能主理家务，又能处理商务；既能教书育童，又懂饮食营养；既会待人接物，又懂礼仪着装；日常采买、洗衣熨烫、简单花艺、宠物饲养、虽不算优秀，也基本上良好', 1,
        '2020-05-02 11:47:08', '2020-05-02 11:47:08');
INSERT INTO `category`
VALUES (4, '育婴早教', '不但对婴幼保育、早期教育有一定的能力，而且在打理家务上与普通家政服务员工相比也不逊色。她们的沟通互动能力和理解能力都是相当不错的', 1, '2020-05-02 11:47:08',
        '2020-05-02 11:47:08');
INSERT INTO `category`
VALUES (5, '钟点服务', '临时用工随叫随到，但不定位到某一个服务钟点工，包月钟点工是定时、定点、定人的固定服务', 1, '2020-05-02 11:47:08', '2020-05-02 11:47:08');
INSERT INTO `category`
VALUES (6, '幼教保育', '善于和儿童做游戏，唱儿歌，讲故事，跳舞蹈和进行户外活动', 1, '2020-05-02 11:47:08', '2020-05-02 11:47:08');
INSERT INTO `category`
VALUES (7, '清洁清洗', '清洁家具和常用电器设备以及各种物品的清理', 1, '2020-05-02 11:47:08', '2020-05-02 11:47:08');
...
(
  ...
  AUTO_INCREMENT = 5
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '清洁服务'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `clean`
VALUES (1, '带孩子哈哈', '正经大孩子', '我喜欢带孩子123', '面议啊', 3, 4, 2, 1, '2020-05-02 23:35:30', '2020-05-02 23:45:53', 3);
INSERT INTO `clean`
VALUES (3, '找个管家', '带娃找个管家', '再次掐额', '200元每小时', 3, 5, 2, 1, '2020-05-02 23:39:29', '2020-05-02 23:39:40', 0);
INSERT INTO `clean`
VALUES (4, '找一个管家', '真的要一个好管家', '好的', '200', 2, 3, 1, 1, '2020-05-02 23:43:23', '2020-05-02 23:43:57', 2);
...
-- ----------------------------
INSERT INTO `comment`
VALUES (1, '你能带多大的孩子？', 3, 2, '2020-05-02 23:41:27');
INSERT INTO `comment`
VALUES (2, '请回复我，抱歉打扰了', 3, 2, '2020-05-02 23:41:37');
INSERT INTO `comment`
VALUES (3, '我可以', 2, 3, '2020-05-02 23:43:54');
INSERT INTO `comment`
VALUES (4, '我都能带', 2, 3, '2020-05-02 23:52:23');
INSERT INTO `comment`
VALUES (5, '那好，我马上下单', 3, 2, '2020-05-02 23:52:44');
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '新闻信息'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `news`
VALUES (1, '“我值得尊重吗？”', '一个保姆的思考', '发生在一个晚上不好吧', 1, '2020-05-02 23:40:18', '2020-05-02 23:40:25');
INSERT INTO `news`
VALUES (2, '系统马上更新', '我们系统则证', '在升级', 2, '2020-05-02 23:40:42', '2020-05-02 23:40:42');
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '服务订单'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `order`
VALUES (1, 3, 4, 2, 3, 2, '2020-05-02 23:43:57', 3, 2);
INSERT INTO `order`
VALUES (2, 4, 1, 2, 3, 3, '2020-05-02 23:45:53', 2, 3);
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '分值记录'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `record`
VALUES (2, '100', 3, 2, '2020-05-02 23:46:37', '2020-05-02 23:46:37');
...
-- ----------------------------
INSERT INTO `user`
VALUES (1, 'admin', '123', '未满18岁', '男', '12345', '北京海淀区123', '', 'test.@163.com', 1);
INSERT INTO `user`
VALUES (2, 'User', '123', NULL, NULL, NULL, NULL, NULL, NULL, 2);
INSERT INTO `user`
VALUES (3, 'work', '123', NULL, NULL, NULL, NULL, NULL, NULL, 3);
